...
Code and sterile-split artifacts (dedup audit, split manifests, eval JSONs, benchmark logs, plotting scripts) are available at \url{https://github.com/jaweed3/paper_poultry_p2}.
