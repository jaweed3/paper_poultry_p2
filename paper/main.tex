...
\title{Diagnosing INT8 Quantization Collapse in EfficientNet-B0: Per-Channel Recovery and Scheme $\times$ Runtime Characterization for Poultry Fecal Disease Detection on Edge CPUs}
